...
userallow:addParam{ type=ULib.cmds.StringArg, hint="命令" }
...
userallowid:addParam{ type=ULib.cmds.StringArg, hint="命令" }
...
userdeny:addParam{ type=ULib.cmds.StringArg, hint="命令" }
...
userdenyid:addParam{ type=ULib.cmds.StringArg, hint="命令" }
...
groupallow:addParam{ type=ULib.cmds.StringArg, hint="命令" }
...
groupdeny:addParam{ type=ULib.cmds.StringArg, hint="命令" }
